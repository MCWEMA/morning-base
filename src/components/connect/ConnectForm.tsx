...
export const ConnectForm: React.FC = () => {
  return (
    <form
      noValidate
      css={ConnectFormStyles}
      action={config.mailchimpAction}
      method="post"
      id="mc-embedded-connect-form"
      name="mc-embedded-connect-form"
    ...
    >
      ...
      <FormGroup className="form-group">
        ...
        <ConnectName
          ...
          type="text"
          name={config.mailchimpNameFieldName}
          id={config.mailchimpNameFieldName}
...
const ConnectEmail = styled.input`
  display: block;
  padding: 10px;
  width: 100%;
...
const ConnectFormButton = styled.button`
  position: relative;
